...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <?php
    if(isset($_POST['addskill'])){
      ...
      $sql = "INSERT INTO `skills` (`id`, `skillname`, `skilllevel`,`description`) VALUES (Null, '$name', '$level','$description')";
  ...
  ?>
    ...
    <form class="w3-container w3-card-4" action="" method = "post">
      ...
      <p>      
      <button class="w3-btn w3-blue" name='addskill'>Confirm</button></p>
    </form>
